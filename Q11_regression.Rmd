...
* If $x$ is the driving distance, we expect the percentage accuracy to be bxbx.
...
* If $x$ is the driving distance, we expect the percentage accuracy to be 100bx100bx.
...
* If we select a new female golfer who averages 260 yards per drive, we are 95% confident that the posterior mean for her accuracy would be in the interval. **[x]**
